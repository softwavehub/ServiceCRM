...
class StaffLeadDataTable extends DataTable
{
    /**
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('email')->title('Email')->name('email'),
            Column::make('phone')->title('Phone')->name('phone'),
        ];
    }
