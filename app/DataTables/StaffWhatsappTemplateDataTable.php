...
use App\Models\StaffWhatsappTemplate;
use App\Models\User;
...
class StaffWhatsappTemplateDataTable extends DataTable
{
    /**
    ...
    public function query(WhatsappTemplate $model)
    {
    ...
    public function getColumns(): array
    {
        return [
            Column::computed('DT_RowIndex', 'No')
                ...
                ->searchable(false)
                ->orderable(false),
            Column::make('title')->title('Title')->name('title'),
            Column::make('message')->title('Message')->name('message'),
    ...
    {
        return 'StaffWhatsappTemplate_' . date('YmdHis');
    }
}
