                ...
                <div class="modal-body">
                    <form id="serviceForm" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-2">
                                <label for="name" class="form-label">Inclusions<span
                                            class="text-danger">*</span></label>
                                <input type="text" name="inclusions" id="inclusions" class="form-control">
                            </div>
                            <div class="col-12 mb-2">
                                <label for="name" class="form-label">Attachment<span
                                            class="text-danger">*</span></label>
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.status == true) {
                            $('#serviceForm').attr('action', '{{route('services.update','id')}}'.replace('id', response.data.id));

                            $('input[name="name"]').val(response.data.name);
                            $('#description').val(response.data.description);
                            $('#inclusions').val(response.data.inclusions);
