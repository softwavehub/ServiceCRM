...
@push('scripts')
    {!! $dataTable->scripts() !!}
    <script>
        $('#serviceForm').attr('action', '{{route('categories.store')}}');
        ...
        function showFormModal(id = '') {
            ...
            if (id != '') {
                ...
                let route = '{{route('categories.edit')}}';
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.status == true) {
                            $('#serviceForm').attr('action', '{{route('categories.update','id')}}'.replace('id', response.data.id));
